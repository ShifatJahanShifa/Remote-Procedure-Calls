...
import inspect   # to get information about live objects like module, class, methods.
from threading import Thread

SIZE=1024  # buffer size to store the data
...
class RPCClient:
    ...
    def connect(self):
        try:
            ...
            raise Exception(f"Client was not able to connect. Error: {e}")
